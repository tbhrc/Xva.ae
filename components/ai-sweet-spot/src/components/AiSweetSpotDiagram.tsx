...
const INITIATIVES: Array<{
  ...
  { x: 240, y: 130, width: 260, height: 40, label: "AI Strategic & Execution Roadmap Workshop", groups: ["strategy"] },
  { x: 390, y: 180, width: 160, height: 40, label: "HTC Campaign", groups: ["strategy"] },
  { x: 820, y: 120, width: 220, height: 40, label: "End in Mind Process Mapping", groups: ["strategy", "execution"] },
  { x: 810, y: 195, width: 180, height: 40, label: "AI Command Room", groups: ["execution"] },
  { x: 840, y: 240, width: 120, height: 40, label: "OKRx", groups: ["execution"] },
  { x: 735, y: 430, width: 190, height: 40, label: "DDDEEE Framework", groups: ["execution", "technology"] },
  { x: 810, y: 540, width: 180, height: 40, label: "SaaS Audit Review", groups: ["technology"] },
  { x: 805, y: 680, width: 190, height: 40, label: "Data Audit Review", groups: ["technology"] },
  { x: 620, y: 620, width: 260, height: 40, label: "AI Agents + Automation Integration", groups: ["technology"] },
  { x: 615, y: 700, width: 170, height: 40, label: "Use Case Library", groups: ["technology"] },
  { x: 240, y: 430, width: 160, height: 40, label: "AI Agility Check", groups: ["strategy", "people"] },
